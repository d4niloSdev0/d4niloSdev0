...
$ cat objectives.txt
[✓] Fortalecer fundamentos em Java
[✓] Desenvolver APIs REST
[→] Aprimorar Spring Boot
[→] Aprimorar SQL e modelagem de bancos de dados
[→] Desenvolver mais projetos para o portfólio
[→] Ganhar experiência profissional
[→] Continuar evoluindo no desenvolvimento backend
